...
public class GlobalExceptionHandler  extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    protected ResponseEntity<Object> MethodArgumentNotValid(
    ...
    public ResponseEntity<Object>handleObjectNotFoundException(
            ...
            WebRequest request){
        log.error("Failed find the requested element ",objectNotFoundException);
        return buildErrorResponse(
    ...
    public ResponseEntity<Object>handleDataBidingViolationException(
            ...
            WebRequest request){
        log.error("Failed to save entity with associated data",dataBidingViolationException);
        return buildErrorResponse(
